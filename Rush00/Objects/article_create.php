...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="article_create.css"/>
</head>
<body>
    <header>
    ...
    <div class="form_box">
        <form action="create.php" method="post">
            ...
            <div class="platforms">
                ...
                {   
                    echo('<br/><input class="create" type="submit" name="submit" value="Creer" required><br/><br/>');
                    echo('<a href="modif_articles_list.php">Modifier un article</a>');
                }
                echo('<br/><br/><a href="create_class.html">Creer une Plateforme</a>');
                ;?> 
            </div>
            <div class="error">
